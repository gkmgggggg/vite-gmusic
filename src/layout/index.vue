<template>
  ...
  <div class="fly bg-fly-circle5"></div>
  <div class="fly bg-fly-circle6"></div>
  <div class="fly bg-fly-circle7"></div>
  <div class="fly bg-fly-circle8"></div>
</template>
